...
-->
		<ul class="global_font">
			<li><a href="<?php echo PRE?>/global-example/dialog" onClick="ui.dialog(this);return false;">Dialog</a>&nbsp;&nbsp;&nbsp;(js only)</li>
			<li><a href="<?php echo PRE?>/global-example/interface">Interface</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo PRE?>/example/interface" onClick="ui.element(this);return false;">via JS</a></li>
			<li><a href="<?php echo PRE?>/global-example/element" >Element</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo PRE?>/example/element" onClick="ui.element(this);return false;">via JS</a></li>
			<li><a href="<?php echo PRE?>/global-example/assets">Assets</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo PRE?>/example/asset" onClick="ui.element(this);return false;">via JS</a></li>
		</ul><br />
<!--
=======================================================================================================================================
-->
...
-->
				...
				<li><a href="<?php echo PRE?>/component-example/example/dialog" onClick="ui.dialog(this);return false;">Dialog</a>&nbsp;&nbsp;&nbsp;(js only)</li>
				<li><a href="<?php echo PRE?>/component-example/example/interface">Interface</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo PRE?>/examplecomponent/example/interface" onClick="ui.element(this);return false;">via JS</a></li>
				<li><a href="<?php echo PRE?>/component-example/example/element">Element</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo PRE?>/examplecomponent/example/element" onClick="ui.element(this);return false;">via JS</a></li>
				<li><a href="<?php echo PRE?>/component-example/example/assets">Assets</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo PRE?>/examplecomponent/example/asset" onClick="ui.element(this);return false;">via JS</a></li>
			</ul>
		</fieldset><br /><br />
<!--
=======================================================================================================================================
...
-->
				<ul class="widget_font">	
					<li><a href="<?php echo PRE?>/example-widget/dialog" onClick="ui.dialog(this);return false;">Dialog</a>&nbsp;&nbsp;&nbsp;(js only)</li>
					<li><a href="<?php echo PRE?>/example-widget/interface" onClick="ui.element(this);return false;">Interface</a></li>
					<li><a href="<?php echo PRE?>/example-widget/element" onClick="ui.element(this);return false;">Element</a></li>
					<li><a href="<?php echo PRE?>/example-widget/assets" onClick="ui.element(this);return false;">Assets</a></li>
				</ul>
			</fieldset>
		</fieldset>
	</fieldset>