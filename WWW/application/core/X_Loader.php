...
class X_Loader extends CI_Loader
{
	 ...
	 * @return void
	 */
	function _component_ci_load ( $obj,$_ci_data )
	{
...
==================================================================*/
	...
	{
		return $this->_component_ci_load ( $obj,array ( '_ci_view' => $view, '_ci_vars' => $this->_ci_object_to_array ( $vars ), '_ci_return' => $return ) );
	}
